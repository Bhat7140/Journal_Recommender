...
EMBEDDING_OUTPUT_ROOT = BASE_DIR / "output" / "embeddings"

EMBEDDING_SCENARIOS = {
    "no_msc_raw": {
        "input_path": BASE_DIR / "output" / "metadata" / "no_msc" / "raw.jsonl",
        "output_dir": EMBEDDING_OUTPUT_ROOT / "no_msc_raw",
    },
    "no_msc_clean": {
        "input_path": BASE_DIR / "output" / "metadata" / "no_msc" / "clean.jsonl",
        "output_dir": EMBEDDING_OUTPUT_ROOT / "no_msc_clean",
    },
    "msc_raw": {
        "input_path": BASE_DIR / "output" / "metadata" / "msc" / "raw.jsonl",

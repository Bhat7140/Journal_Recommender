...
from search_backends.opensearch_backend import bulk_index_no_msc, load_opensearch_client


def main():
    parser = argparse.ArgumentParser(
        description="Index no-MSC works and embeddings into local OpenSearch."
    )
    parser.add_argument("--index-name", default=NO_MSC_INDEX_NAME)
    parser.add_argument("--embedding-dir", default=NO_MSC_EMBEDDING_DIR)
    ...
    print("[DONE] OpenSearch no-MSC index")
